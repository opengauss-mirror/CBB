...
#define CM_SCSI_XFER_DATA_LEN_24 24
...
#define CM_MAX_RKEY_COUNT CM_MAX_INSTANCES

#define SAM_CHECK_CONDITION 0x02
#define SAM_RESERVATION_CONFLICT 0x18
#define SAM_COMMAND_TERMINATED 0x22

// the sense key indicates that the source data did not match the data read from the
// medium
#define CM_SPC_SK_MISCOMPARE 0xe
