 ...
 *
 * IDENTIFICATION
 *    src/ddes_lexer/ddes_key_word.h
 *
 * -------------------------------------------------------------------------
 */

#ifndef __DDES_KEY_WORD_H__
#define __DDES_KEY_WORD_H__
...
typedef enum en_hint_key_wid {
    HINT_KEY_WORD_INVALID = 0x00000000,
    ...
    HINT_KEY_WORD_PARALLEL = 0x00000080,

    /* query hints below */
    // rbo
    HINT_KEY_WORD_RULE = 0x00000100,

    // join order
    HINT_KEY_WORD_LEADING = 0x00000200,
    HINT_KEY_WORD_ORDERED = 0x00000400,

    // join method
    HINT_KEY_WORD_USE_NL = 0x00000800,
    HINT_KEY_WORD_USE_MERGE = 0x00001000,
    HINT_KEY_WORD_USE_HASH = 0x00002000,

    /* insert hints below */
    HINT_KEY_WORD_HASH_BUCKET_SIZE = 0x00004000,

#ifdef Z_SHARDING
    /* Z_SHARDING hints below */
    // from subquery pullup
    HINT_KEY_WORD_MERGE = 0x00008000,
    HINT_KEY_WORD_NO_MERGE = 0x00010000,
#endif

    /* replace hints below */
    HINT_KEY_WORD_THROW_DUPLICATE = 0x00020000,

#ifdef Z_SHARDING
    HINT_KEY_WORD_SQL_WHITELIST = 0x00040000,
    HINT_KEY_WORD_SHD_READ_MASTER = 0x00080000,
#endif
} hint_key_wid_t;
