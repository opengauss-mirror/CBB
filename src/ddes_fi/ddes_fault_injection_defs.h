 ...
 * -------------------------------------------------------------------------
 *
 * ddes_fault_injection_defs.h
 * -------------------------------------------------------------------------
 */
#ifndef DDES_FAULT_INJECTION_DEFS_H
#define DDES_FAULT_INJECTION_DEFS_H
...
#define DDES_FI_ENTRY_END (DDES_FI_ENTRY_COUNT + DDES_FI_ENTRY_BEGIN)
...
/*
* the follow defines SHOULD be the same as the defines in cbb/ddes_fi/ddes_fault_injection.h
...
#endif  // DDES_FAULT_INJECTION_DEFS_H